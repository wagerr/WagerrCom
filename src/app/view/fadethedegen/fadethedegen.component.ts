...
@Component({
  selector: 'app-fadethedegen',
  templateUrl: './fadethedegen.component.html',
  styleUrls: ['./fadethedegen.component.scss']
})
export class FadethedegenComponent implements OnInit {
